...
namespace UsuariosRegistration.API.User.Infrastructure
{
    public class UsuarioRepository : IUsuarioRepository
    {
        ...
        public ICollection<Usuario> GetAll()
        {
            ...
            //using SqlConnection connection = ConnectionManager.OpenConnection();
            //connection.Query<Usuario, HistoricoEscolar, Escolaridade, bool>(sql, (c, cc, s) =>
            //{
            //    usuario = c;
            //},
            //splitOn: "id, contract_id, id");

            //return usuario;


            //using SqlConnection connection = ConnectionManager.OpenConnection();
            //return connection.Query<Usuario>($@"SELECT * FROM Usuarios u")
            //    .SingleOrDefault();
        }
